...
PLUGIN_EVENT(void) OnRender()
{
	...
	if (DrawCombomode->Enabled())
	{
		...
		if (ComboMode == 0)
		{
			GRender->DrawTextW(Vec2(worldToScreen.x, worldToScreen.y), Vec4(156, 123, 190, 255), "RETQW");
		}
		if (ComboMode == 1)
		{
			GRender->DrawTextW(Vec2(worldToScreen.x, worldToScreen.y), Vec4(156, 123, 190, 255), "REQWT");
		}
		if (ComboMode == 2)
		{
			GRender->DrawTextW(Vec2(worldToScreen.x, worldToScreen.y), Vec4(156, 123, 190, 255), "RETWQ");
		}		
	}
	/*if (DrawCombomode->Enabled())
	{
